...
if __name__ == '__main__':
    ...
    print('Sequence Recommendation:')
    print('m1. Comirec')
    
    print('Simon\'s Recommenders:')
    print('l1. ConsisRecplus    l2. EDCM        l3. ConsisRec   l4. SLDR    l5. EISR    l6. DisGNN')
    print('l7. DiffNet++        l8. DiffNetLG   l9. MultiVAE    l10. FGR    l11. LGCN' )
    
    print('='*80)
    num = input('please enter the number of the model you want to run:').lower()
    import time
    s = time.time()
    ...
    models = {'1':'UserKNN','2':'ItemKNN','3':'BasicMF','4':'SlopeOne','5':'SVD','6':'PMF',
                 ...
                 'g1':'NGCF', 'g2':'LightGCN', 'g3':'ESRF', 'g4':'DHCF', 'g5':'DiffNet', 'g6':'LightGCN_LH',
                 'q1':'SGL', 'q2':'SEPT', 'q3':'BUIR', 'q4':'MHCN', 'q5':'GACL', 'q7':'SimGCL',
                 'b1':'UserMean','b2':'ItemMean','b3':'MostPopular','b4':'Rand',
                 'm1':'Comirec',
                 'l1':'ConsisRecplus','l2':'EDCM','l3':'ConsisRec','l4':'SLDR','l5':'EISR','l6':'DisGNN',
                 'l7':'DiffNetplus', 'l8': 'DiffNetLG', 'l9':'MultiVAE', 'l10':'FGR', 'l11':'LGCN'}
    try:
    ...
    with open('running_time.txt','a') as fp:
        fp.write(', running time is'+str(e-s)+'s\n')
